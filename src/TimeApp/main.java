...
class LoginOkTimerThread extends Thread{
	public void run() {
		long time = System.currentTimeMillis();
		SimpleDateFormat simple = new SimpleDateFormat("aa hh시 mm분 ss초");
...
class Win7Quiz01 extends TimerQuiz{
	private String[] name;
	private String[] info;
...
public static void main(String[] args){
    ...
    Login01 lo = new Login01("계산기","메모장","calc.exe","notepad.exe"); boolean flag=true;
    lo.time();
    while(flag){
